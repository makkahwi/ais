...
<div class="form-group col-md-6">
  <label for="titleSw">@include('labels.coursen')</label>
  <input type="text" class="form-control" name="titleSw" id="titleSw" readonly>
</div>

<!-- code Field -->
<div class="form-group col-md-6">
  <label for="codeSw">@include('labels.coursec')</label>
  <input type="text" class="form-control" name="codeSw" id="codeSw" readonly>
</div>

<!-- textBook Field -->
<div class="form-group col-md-6">
  <label for="textBookSw">@include('labels.tbook')</label>
  <input type="text" class="form-control" name="textBookSw" id="textBookSw" readonly>
</div>
