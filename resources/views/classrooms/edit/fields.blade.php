...
<div class="form-group col-md-6">
    ...
    <input required type="number" min="0" class="form-control" name="roomNo" id="roomNoEd">
</div>

<!-- Capacity Field -->
<div class="form-group col-md-6">
    <label for="capacity">@include('labels.capa')</label>
    <input required type="number" min="0" class="form-control" name="capacity" id="capacityEd">
</div>
...
<div class="form-group col-md-6">
    ...
    <select required class="form-control" name="supervisor_id" id="teacher_idEd">
