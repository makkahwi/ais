...
<div class="form-group col-md-6">
    ...
    <input required type="date" min={{today()}} class="form-control" name="start" id="startEd">
</div>

<!-- join Field -->
<div class="form-group col-md-6">
    <label for="join">@include('labels.jdate')</label>
    <input required type="date" min={{today()}} class="form-control" name="join" id="joinEd">
</div>

<!-- results Field -->
<div class="form-group col-md-6">
    <label for="results">@include('labels.rdate')</label>
    <input required type="date" min={{today()}} class="form-control" name="results" id="resultsEd">
</div>

<!-- end Field -->
<div class="form-group col-md-6">
    <label for="end">@include('labels.edate')</label>
    <input required type="date" min={{today()}} class="form-control" name="end" id="endEd">
