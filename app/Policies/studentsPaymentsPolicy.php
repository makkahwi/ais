...
class studentsPaymentsPolicy
{
     ...
     *
     * @param  \App\User  $user
     * @param  \App\studentsPayments  $studentsPayments
     * @return mixed
     */
    public function view(User $user, studentsPayments $studentsPayments)
    {
        return in_array($user->role_id, [
            1, 2, 3, 5, 7, 8
        ]);
     ...
     * @return mixed
     */
    public function restore(User $user, studentsPayments $studentsPayments)
    {
        //
    }
     ...
     * @return mixed
     */
    public function forceDelete(User $user, studentsPayments $studentsPayments)
    {
        //
    }
}
