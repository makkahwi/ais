...
class studentsPolicy
{
  ...
  /**
   * Determine whether the user can update the student financial profile.
   *
   * @param  \App\User  $user
   * @return mixed
   */
  ...
  /**
   * Determine whether the user can update the student financial settlement / blocking from marks.
   *
   * @param  \App\User  $user
   * @return mixed
   */
